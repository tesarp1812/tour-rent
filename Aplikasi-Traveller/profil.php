	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			...
			if (isset($_SESSION['id_user'])) {
				...
				// Membuat koneksi ke database menggunakan ekstensi mysqli
				...
				// Jika koneksi berhasil, lanjutkan dengan penggunaan koneksi
			...
			<div class="fh5co-hero">
				...
				<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/pexels-profil.png);">
					<div class="desc">
						<div class="container">
							<div class="row">
		...
		<div id="fh5co-contact" class="fh5co-section-gray">
			...
			<div class="container">
				...
				<form action="proses.php?aksi=update" method="post" enctype="multipart/form-data">
					...
					// if ($query) {
					// 	echo "Query berhasil dieksekusi."; // Pesan jika query berhasil
					// } else {
					// 	echo "Query gagal dieksekusi."; // Pesan jika query gagal
					// }
					?>
					...
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<p><img src="foto/member/<?php echo $d['foto'] ?>" width='250x' height='250px' /></p>
