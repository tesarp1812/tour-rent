  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/pexels-ordr.png);">
				<div class="desc">
					<div class="container">
						<div class="row">
...
<li><strong>Jika anda sudah di lokasi kami, silahkan pilih asal keberangkatan BRV Office (bebas biaya transport)</strong></li>
...
<?php endforeach; ?>
							...
							<input type="text" name="tgl_pesan" class="form-control"  id="date-start" />
