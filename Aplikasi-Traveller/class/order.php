...
class order extends database
{
	...
	function tampil_data()
	{
		$sql = "SELECT * 
            ...
            ORDER BY tbl_pesan.tgl_pesan DESC";
	...
	{
		$sql = "SELECT tbl_user.nama_user, tbl_pesan.id_pesan, tbl_bukti.file 
            FROM tbl_pesan, tbl_user, tbl_bukti 
            WHERE tbl_pesan.id_user = tbl_user.id_user 
              AND tbl_pesan.id_pesan = tbl_bukti.id_pesan 
            ORDER BY tbl_pesan.id_pesan DESC";
