	...
	$user = new user();
	 ...
	 ?>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/Pexels-login.png);">
				<div class="desc">
					<div class="container">
						<div class="row">
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h3>Sebelum anda login untuk melakukan pembokingan tiket,
										 alangkah baiknya mendaftarkan diri terlebih dahulu di 
										 form yang telah tersedia di bawah</h3>
				...
				<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<p>Perusahaan kami bergerak di bidang penyewaan jasa tour and travel. kami melayani untuk melakukan tour di wilayah Flores.</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Jalan mataloko-ende</li>
								<li><i class="icon-phone2"></i>+62 813 5904 3635</li>
								<li><i class="icon-mail"></i><a href="#">BrvRentCar@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.BrvRentCar.com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
