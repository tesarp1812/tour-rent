...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="myModalLabel">Edit Data Gallery</h4>
    </div>

    <div class="modal-body">
      <form action="prosesReview.php?aksi=update" method="post" enctype="multipart/form-data">
        <?php
        ...
        ?>
          <div class="row animate-box">
            <div class="col-md-6">
              ...
              <p><img src="../images/index/<?php echo $d['gambar'] ?>" width='250x' height='250px' /></p>
