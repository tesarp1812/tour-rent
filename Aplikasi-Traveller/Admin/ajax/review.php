						...
						<tbody>
							...
							?>
								...
								<tr>
									...
									<td><img class="img-rounded" src="../images/review/<?php echo $x['gambar']; ?>" alt=""></td>
									...
									<td>
										...
										<a href="#" onclick="confirm_modal('prosesReview.php?id=<?php echo $x['id']; ?>&aksi=hapus');"><button type="button" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Data"><i class="fa fa-trash-o"></i></button></a>
									</td>
								</tr>
...
include('../modal/modal_tambah_review.php');
